-- Migration to fix parsing_job_status enum issue - Version 2
-- Run this in psql with: \i backend/src/database/migrations/007_fix_parsing_job_status_v2.sql
...
-- Drop and recreate the constraint to be sure (after fixing data)
