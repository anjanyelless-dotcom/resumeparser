...
const tabs = [
  { id: 'shortlisted-candidates', label: 'Shortlisted Candidates' },
...
export default function HiringProcessPage() {
  ...
  const [activeTab, setActiveTab] = useState('shortlisted-candidates');
  ...
  useEffect(() => {
    ...
    } else if (location.pathname.endsWith('/hiring-process')) {
      setActiveTab('shortlisted-candidates');
    }
  }, [location.pathname]);
    ...
    <div className="p-6 min-h-full bg-gray-50 flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1 text-sm">
          {currentRequirementId
            ? `Hiring workflow for ${currentRequirementTitle}`
